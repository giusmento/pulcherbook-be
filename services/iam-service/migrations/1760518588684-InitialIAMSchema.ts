...
export class Migration1760518588684 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "iam"."groups" ("uid" uuid NOT NULL DEFAULT uuid_generate_v4(), "userType" "iam"."groups_usertype_enum" NOT NULL, "name" character varying(255) NOT NULL, "default" boolean NOT NULL DEFAULT false, "description" character varying(255) NOT NULL, "permissions" character varying(255) NOT NULL, "isVisible" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_4163ae2a10a069a5f983e40a3f1" PRIMARY KEY ("uid"))`
    );
    await queryRunner.query(
