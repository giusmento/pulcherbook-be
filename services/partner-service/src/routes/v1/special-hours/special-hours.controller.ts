...
export class SpecialHoursController {
  /**
   * @swagger
   * /api/v1/partners/{partner_uid}/shops/{shop_uid}/special-hours/{uid}:
   *   get:
  ...
  public async findById(
    ...
    Response<PBTypes.partner.api.v1.specialHours.GET.ResponseBodySingle>
  > {
  ...
  /**
   * @swagger
   * /api/v1/partners/{partner_uid}/shops/{shop_uid}/special-hours:
   *   get:
   ...
   * /api/v1/partners/{partner_uid}/shops/{shop_uid}/special-hours/:
   *   put:
   *     summary: Update multiple special hours
   *     tags: [SpecialHours]
   *     security:
   *       - bearerAuth: []
   *     parameters:
  ...
  public async upsertMultiple(
    req: Request<
      ...
      PBTypes.partner.api.v1.specialHours.POST.RequestBodyMultiple,
      PBTypes.partner.api.v1.specialHours.POST.QueryParams
    >,
    res: Response<PBTypes.partner.api.v1.specialHours.POST.ResponseBodyMultiple>
  ): Promise<
    Response<PBTypes.partner.api.v1.specialHours.POST.ResponseBodyMultiple>
  > {
    const logRequest = new utils.LogRequest(res);
    try {
      const { shopUid } = req.params;
  ...
  public async delete(
    ...
    Response<PBTypes.partner.api.v1.specialHours.DELETE.ResponseBody>
  > {
    const logRequest = new utils.LogRequest(res);
    try {
